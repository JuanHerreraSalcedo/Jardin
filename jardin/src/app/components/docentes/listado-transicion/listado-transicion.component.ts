...
@Component({
  selector: 'app-listado-transicion',
  templateUrl: './listado-transicion.component.html',
  styleUrls: ['./listado-transicion.component.scss']
})
export class ListadoTransicionComponent implements OnInit {
  estudiantes!: any[];
